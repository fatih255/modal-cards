import { CheckBoxListProps, default as Component } from "components/panelComponents/CheckBoxList";
...
CheckBoxList.args = {
    items: [
        { checked: false, text: "Send form submissions", value: "sendFormSubmission" },
