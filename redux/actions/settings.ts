...
const settingsActions = {
    settingStatus: (state: WritableDraft<ModalType>, action: PayloadAction<keyof ModalType['settings']>) => { //payload is settings name
    ...
    updateSettings: (state: WritableDraft<ModalType>, action: PayloadAction<{ name: keyof ModalType['settings'], value: string | string[] | boolean | null }>) => {
