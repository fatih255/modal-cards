      ...
      <section className="pt-24">
        <Flexing>
          ...
          <section className="close-sticky">
            <Title className="mb-[50px] mt-[50px] text-center">Conversion & UX ready popups & modals</Title>
            <div className="flex justify-center items-stretch gap-[30px]">
              <div className="flex flex-col flex-1 justify-start items-center gap-6 bg-design-gray-100 rounded-xl pt-14 pb-20">
                ...
                <div className="flex flex-col items-center mt-[10px]">
                  ...
                  <p className="px-[70px] text-center text-sm leading-[20px] tracking-[-1%]">Helps you calculate your email marketing roi to measure success.</p>
                </div>
              </div>
              <div className="flex flex-col flex-1 justify-start items-center gap-6 bg-design-gray-100 rounded-xl pt-14 pb-20">
                <PixelPerfectIcon />
                <div className="flex flex-col items-center mt-[10px]">
                  <h3 className="font-semibold text-lg mb-1" >Conversion Ready</h3>
                  <p className="px-[101px] text-center text-sm leading-[20px] tracking-[-1%]">
                    Empowers your emails by generating a free code for a CTA in your subject line.
                  </p>
                </div>
              </div>
              <div className="flex flex-col flex-1 justify-start items-center gap-6 bg-design-gray-100 rounded-xl pt-14 pb-20">
                <ModernUsefulIcon />
                <div className="flex flex-col items-center mt-[10px]">
                  <h3 className="font-semibold text-lg mb-1" >Modern & Useful</h3>
          ...
          <section>
            <Title className="mt-[120px] mb-[50px] text-center">Frequently Asked Questions</Title>
            <div>
          ...
          <section>
            <Title className="mt-[120px] mb-[50px] text-center">Build great popups without code</Title>
            <div className="flex flex-row gap-5 items-stretch justify-center w-full">
              <div className="flex flex-1 flex-col items-center">
                ...
                <span className="leading-[24px] text-center font-semibold text-lg mt-[30px] mb-[10px]">Targeting Options</span>
                <p className="text-center max-w-[250px] leading-[20px] text-sm tracking-[-1%]">Target +26 trigger to your visitors</p>
              </div>
              <div className="flex flex-1 flex-col items-center">
                <div className="bg-primary rounded-full p-8">
                  <TargetingOptions2Icon />
                </div>
                <span className="leading-[24px] text-center font-semibold text-lg mt-[30px] mb-[10px]">No-Code</span>
                <p className="text-center max-w-[180px] leading-[20px] text-sm tracking-[-1%]">No code required while you’re creating a popup</p>
              </div>
              <div className="flex flex-1 flex-col items-center">
                <div className="bg-primary rounded-full p-8">
                  <AwsIcon />
                ...
                <span className="leading-[24px] text-center font-semibold text-lg mt-[30px] mb-[10px]">Targeting Options</span>
                <p className="text-center max-w-[213px] leading-[20px] text-sm tracking-[-1%]">Integrated with your marketing and CRM platforms</p>
              </div>
              <div className="flex flex-1 flex-col items-center">
                <div className="bg-primary rounded-full p-8">
                  <NoCodeIcon />
                ...
                <span className="leading-[24px] text-center font-semibold text-lg mt-[30px] mb-[10px]">Targeting Options</span>
                <p className="text-center max-w-[200px] leading-[20px] text-sm tracking-[-1%]">Don’t worry about speed and Amazon AWS resources</p>
              </div>
            </div>
          </section>
        </Flexing>
