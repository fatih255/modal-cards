    ...
    return (
        <div className={`relative flex ${containerClass} ${extraClass}`}>
            <div className="flex-1 text-center p-8 w-full ">
                ...
                <div className="p-4">
                    <span className="text-[40px] font-semibold tracking-tighter">{texts[0]}</span>
                    <p className="my-2  ">
                        {texts[1]}
                        <br /><span className="font-semibold underline"> {texts[2]}</span> {texts[3]}
                    </p>
                    ...
                    <button className="p-3 font-semibold rounded-xl bg-black hover:bg-opacity-70 text-white  w-full transition-all duration-300">{texts[4]}</button>
            ...
            <div className="flex-1 relative select-none">
                ...
                <div className="z-10 absolute w-full h-full">
                    ...
                    <div className="flex flex-col-reverse h-full p-6">
                        <span className="flex max-w-xs w-0 text-4xl text-white font-semibold tracking-tight">{texts[9]}</span>
                    </div>
                </div>
            </div>
