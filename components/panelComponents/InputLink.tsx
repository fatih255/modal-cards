...
export default function InputLink({ onChange, iconName = 'AiOutlineLink', placeholder = 'Paste Post Request URL' }: InputLinkProps) {
    ...
    return (
        <div className="flex flex-row justify-center items-center">
            ...
            <input onChange={onChangeHandler} className="default-input !ring-0 !rounded-tl-none !rounded-bl-none " placeholder={placeholder} />
        </div>
    )
}